 ...
 * {@link AbstractModelRequest}. Mainly useful to execute requests from the UI
 ...
 * 
 * @param <E>
 *            The type of {@link JsonModel} object to receive
 */
@Beta
public interface ModelResponseCallback<E extends JsonModel> {
	 ...
	 * response JSON) or any other exception
	 * 
	 * @param ex
