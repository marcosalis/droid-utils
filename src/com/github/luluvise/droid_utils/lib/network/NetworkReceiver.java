...
import com.github.luluvise.droid_utils.lib.network.NetworkBroadcastReceiver.NetworkIntent;
...
public abstract class NetworkReceiver extends BroadcastReceiver {
	...
	/**
	 * Do <b>NOT</b> override this unless you need custom behaviour.<br>
	 * Implement onConnectionActive() and onConnectionGone() instead.
	 */
	@Override
	public final void onReceive(Context context, Intent intent) {
		...
		NetworkIntent netIntent = (NetworkIntent) intent;
