...
/**
 * Some customizations made by Marco Salis
 * 
...
public class IndexScroller {
	...
	// static handler to prevent leaks
	private static class ScrollerHandler extends Handler {

		private final SoftReference<IndexScroller> mScroller;

		public ScrollerHandler(IndexScroller scroller) {
			mScroller = new SoftReference<IndexScroller>(scroller);
		}
		...
		public void handleMessage(Message msg) {
			...
			final IndexScroller scroller = mScroller.get();
			if (scroller != null) {
				scroller.handleMessage(msg);
			}
		}
	}
	...
	public void setIndexFadingEnabled(boolean fadeIndex) {
		mIsIndexFadingEnabled = fadeIndex;
	}

	// custom layout for the index bar
